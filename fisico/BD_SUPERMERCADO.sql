...
CREATE TABLE IF NOT EXISTS FUNCIONARIO(
	CPF VARCHAR(14) PRIMARY KEY,
    JORNADFA_TRABALHO VARCHAR(10) NOT NULL,
...
-- ALTERAR TABELA CONSUMIDOR, ADICIONAR DATA_NACIMENTO
ALTER TABLE CONSUMIDOR
ADD COLUMN DATA_NACIMENTO DATE NOT NULL;

-- ALTERAR TABELA SUPERMERCADO, MODIFICAR COLUNA TELEFONE
ALTER TABLE SUPERMERCADO
CHANGE COLUMN TELEFONE TELEFONE_SUPERMERCADO VARCHAR(15);

-- ALTERAR TABELA SUPERMERCADO, MODIFICAR COLUNA LOGRADOURO
ALTER TABLE SUPERMERCADO
